...
export default class NotifService {
  ...
  scheduleNotif(soundName, date, msg) {
    this.lastId++;
    PushNotification.localNotificationSchedule({
      date: (date) ? date : new Date(Date.now() + 10 * 1000), // in 30 secs
      ...
      message: msg ? msg : 'My Notification Message', // (required)
  ...
  scheduleNotifMultiple(){
    const max = 25;
    let today00 = moment().startOf('day');
    let currDate = today00.clone().add(1, 'd');
    let currHour = 8;
